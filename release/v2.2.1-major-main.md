...
![finalcut_open](../assets/v2.2.1/finalcut_open.png)
...
> ⚠️ 테스트 버전이므로 정상적으로 동작하지 않을 수 있습니다. 불편함을 겪으시면 재빨리 (주)인바이즈 홈페이지로 문의주세요.
...
- 프리셋
  ...
  ![preset_multi_select](../assets/v2.2.1/preset_molti_select.gif)
